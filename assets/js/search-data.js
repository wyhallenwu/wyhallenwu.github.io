...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          description: "",
          section: "News",},{id: "news-my-first-author-paper-background-fades-foreground-leads-curriculum-guided-background-pruning-for-efficient-foreground-centric-collaborative-perception-has-been-accepted-by-icra-2026-we-release-all-the-code-checkpoints-including-all-baselines-and-visulizations-for-reproducibility-welcome-to-fork",
          title: 'My first author paper “Background Fades, Foreground Leads: Curriculum-Guided Background Pruning for Efficient...',
          description: "",
          section: "News",},{id: "news-our-paper-last-but-not-least-boundary-attention-calibration-for-multimodal-kv-cache-compression-has-been-accepted-by-emnlp-2026-check-out-the-code",
          title: 'Our paper “Last But Not Least: Boundary Attention CalibratiON for Multimodal KV Cache...',
          description: "",
